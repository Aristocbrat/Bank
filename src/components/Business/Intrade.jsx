...
const Intrade = () => {
  return (
    <div>
      <div id="Intrade" className='flex xl:flex-row sm:flex-col justify-center xl:py-16 sm:py-8 gap-6
      bg-white rounded-tl-3xl rounded-br-3xl w-[100%] border-b border-black overflow-hidden'>
      <div className="">
            <h1 className='xl:text-5xl sm:text-4xl flex py-3 sm:justify-center xl:justify-start font-extrabold'>International Trade</h1>
