  ...
  return (
    <div>
      ...
      bg-navbarBg text-yellow-400 flex justify-center flex-col items-center text-lg rounded-tl-3xl rounded-br-3xl">
          <p className='flex text-4xl'>{props.icon} {props.title}</p>
           <p className='px-3 w-full py-3 mt-4 gap-3 flex justify-center'>{props.ftext}</p>
    ...
    <div class="card-back bg-[#FFB200] rounded-tr-3xl rounded-bl-3xl
     flex justify-center flex-col items-center text-navbarBg text-lg ">
      ...
      <ul className='py-3'>
        ...
        <li className='flex hover:translate-x-4 hover:duration-500'><FiChevronsRight className='mt-[6px]' /><a href="#">{props.li3}</a></li>
        <li className='flex hover:translate-x-4 hover:duration-500'><FiChevronsRight className='mt-[6px]'/><a href="#">{props.li4}</a></li>
      </ul>
      <button className='rounded-tl-3xl rounded-br-3xl p-3 bg-navbarBg text-yellow-500 hover:scale-50 hover:duration-700 transition hover:ease-in-out'>
